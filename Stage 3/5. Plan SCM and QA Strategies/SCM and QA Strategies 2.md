...
## Team Structure
- Dev1: Backend APIs (`Node.js`/`Express`), auth, request lifecycle
- Dev2: Frontend (`React`) and user flows
- Dev3: Data and integrations (`MySQL`, `Firebase Firestore`, `Firebase Storage`)
- Dev4: Payments and platform operations (`Moyasar`, admin/support flows)
